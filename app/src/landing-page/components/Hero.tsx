...
import openSaasBannerDark from "../../client/static/open-saas-banner-dark.webp";
import openSaasBannerLight from "../../client/static/open-saas-banner-light.webp";
        ...
        <div className="max-w-8xl mx-auto px-6 lg:px-8">
          <div className="lg:mb-18 mx-auto max-w-3xl text-center">
            <h1 className="text-foreground text-5xl font-bold sm:text-6xl">
              Meet <span className="italic">Amigo</span> —{" "}
              <span className="text-gradient-primary">Your Personal AI Agent</span>
            </h1>
            <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-lg leading-8">
              Everyone deserves their own AI agent. Amigo gives you a cloud-based, pre-built personal assistant — activated instantly, ready to work, and fully yours.
            </p>
