...
const PricingPage = () => {
  ...
  async function handleBuyNowClick(paymentPlanId: PaymentPlanId, billingCycle: BillingCycle) {
    if (!user) {
      navigate("/login");
      return;
    }
                ...
                <CardFooter>
                  {isFree ? (
                    ...
                    <Button
                      ...
                      variant={
                        planKey === bestDealPaymentPlanId ? "default" : "outline"
                      }
                      className="w-full"
                    >
                      Manage Subscription
                    ...
                    <Button
                      onClick={() => handleBuyNowClick(planKey as PaymentPlanId, billingCycle)}
