import { type Entity, type EntityName, type User, type GptResponse, type Task, type DailyStats, type PageViewSource, type Logs, type ContactFormMessage, type ZeroclawInstance } from 'wasp/entities';
...
export type _Entity = _User | _GptResponse | _Task | _DailyStats | _PageViewSource | _Logs | _ContactFormMessage | _ZeroclawInstance | never;
