import { type _User, type _GptResponse, type _Task, type _DailyStats, type _ZeroclawInstance, type AuthenticatedQueryDefinition, type Payload } from 'wasp/server/_types';
